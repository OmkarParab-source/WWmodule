...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_checkpoint_path', type=str, default="checkpoints", help='Path to save the best checkpoint')
    parser.add_argument('--train_data_csv', type=str, default="E:\\Prototype\\WWmodule\\NeuralNet\\model_data\\training_data.csv", required=False, help='path to train data json file')
    parser.add_argument('--test_data_csv', type=str, default="E:\\Prototype\\WWmodule\\NeuralNet\\model_data\\testing_data.csv", required=False, help='path to test data json file')
